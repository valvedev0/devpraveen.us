...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome. I am Praveen Pathak. This is my terminal based website in which you can know about me using the commands given. :)\nNow in order to get started, feel free to either execute the 'help' command or use the more user-friendly colored sidenav at your left.\nIn order to skip text rolling, double click/touch anywhere.\nMake sure to use the follwing commands to know about me.\ncat about.txt - displays my personal info.\n cat projects.txt - displays the list of projects I was/am a part of.\ncat linkedin.txt - Redirects to my LinkedIn profile page in a new tab.\ncat github.txt - Redirects to my github page in a new tab.",
